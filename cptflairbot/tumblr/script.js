...
$(document).ready(function() {
    ...
    $("[type=submit]").click(function(e) {
        e.preventDefault();
        var message =  encodeURIComponent($("#ign").val()) + encodeURI(' | ' + $("#fc").val() + ' | ' + $('select').val() + '\n\nDo not edit this message, just click send!');
        window.location = 'http://www.reddit.com/message/compose/?to=CPTFlairBot2&subject=Flair&message=' + message;
    });
